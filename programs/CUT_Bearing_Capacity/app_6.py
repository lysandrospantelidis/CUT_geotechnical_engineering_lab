...
COULOMB_FILE = "CUT_K_Coulomb.py"
LOGO_FILE = "cut_logo.png"
BRAND_FILE = "Cut bearing capacity.png"
CUT_EXE_URL = "https://github.com/lysandrospantelidis/CUT_geotechnical_engineering_lab/releases/download/v7.1/CUT_Bearing_capacity_updated_v7_1.exe"
...
with st.sidebar:
    ...
    if Path(MANUAL_FILE).exists():
        st.download_button(
            ...
            data=Path(MANUAL_FILE).read_bytes(),
