...
SOURCE_FILE = BASE_DIR / "CUT_Bearing_capacity_updated_v7_2a.py"
...
Version: v7.2 (Program), v3 (Manual)
...
if "results" in st.session_state:
    ...
    with tabs[3]:
        st.write("The web app follows the final v7.2 program and v3 manual, including the original EN 1997-3 checkbox logic, βA/βP and KA/KP inputs, and CUT_K_Coulomb as an auxiliary download tool.")
